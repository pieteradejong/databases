...
//USE IDs FOR USERS ON PER SESSION BASIS
// ROOMS PERSIST and at the start of every session the client gets list of rooms from server (including IDs, which it will use subsequently)
